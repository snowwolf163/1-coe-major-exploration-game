...
export class MajorECE extends Card {
  constructor(scene) {
    ...
    this.displayDescription = "Transform the world in virtually any industry as an electrical and computer engineer. As an electrical and computer engineering student at Oregon State, you'll learn to design, build, and support new technologies while refining existing systems, processes, and products. You'll benefit from one of the most innovative and hands-on undergraduate degree programs in the Pacific Northwest, with expert faculty and a cutting-edge curriculum.";
...
export class MajorRHP extends Card {
  constructor(scene) {
    ...
    this.displayDescription = "Radiation health physics involves the study of ionizing radiation and developing systems and methods to protect people and their environments from radiation hazards. Radiation health physicists protect us from the potential dangers of exposure to radiation. Their responsibilities may include managing radiation safety at nuclear plants and hospitals; designing radiation shields for industrial and medical applications; designing sophisticated radiation detection systems; researching the effects of radiation on the environment; and providing radiation protection training.";
